...
from .serializers import OperacaoEventoSerializer


class OperacaoEventoView(APIView):
    ...
    def get(self, request, evento_id: int):
        ...
        operacao, _ = OperacaoEvento.objects.get_or_create(evento=evento)
        serializer = OperacaoEventoSerializer(operacao)
    ...
    def patch(self, request, evento_id: int):
        ...
        serializer = OperacaoEventoSerializer(operacao, data=request.data, partial=True)

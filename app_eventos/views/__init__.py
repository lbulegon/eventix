...
def home(request):
    ...
    Evita redirect automático para empresa (causava ERR_TOO_MANY_REDIRECTS).
    """
    ...
    # EXCEÇÃO: admin_empresa/operador_empresa - NÃO redirecionar da raiz para evitar
    # loop com /empresa/login/ quando há inconsistência de sessão/cookie
    user = request.user
    ...
    # admin_empresa/operador_empresa: mostrar home com links (evita redirect loop)
    # Usuário acessa /empresa/ ou /empresa/login/ diretamente
    return render(request, "home.html")

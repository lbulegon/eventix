...
urlpatterns = [
    ...
    path('operacao/pontos/<int:pk>/excluir/', views_operacao_dashboard.operacao_ponto_excluir, name='operacao_ponto_excluir'),
    ...
    path(
        'operacao/unidades/<int:unidade_pk>/carga-semanal/',
